...
#define MyAppExeName "run_main.bat"
...
Source: "build-msvc-x64\Release\main.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "build-msvc-x64\run_main.bat"; DestDir: "{app}"; Flags: ignoreversion
...
begin
  ...
  Result := Result + Space + '- main.exe' + NewLine;
  Result := Result + Space + '- run_main.bat' + NewLine;
