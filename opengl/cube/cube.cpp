...
wxBEGIN_EVENT_TABLE(TestGLCanvas, wxGLCanvas) EVT_PAINT(TestGLCanvas::OnPaint)
    ...
    : wxGLCanvas(parent, wxID_ANY, attribList, wxDefaultPosition, wxDefaultSize,
      ...
      m_xangle(30.0), m_yangle(30.0), m_spinTimer(this, SpinTimer),
      m_useStereo(false), m_stereoWarningAlreadyDisplayed(false) {
  if (attribList) {
    int i = 0;
...
void MyFrame::OnNewWindow(wxCommandEvent &WXUNUSED(event)) { new MyFrame(); }
